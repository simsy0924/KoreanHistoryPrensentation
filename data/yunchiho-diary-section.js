...
(function(){
  ...
  function buildIntroSlide(entries){
    ...
    return {
      ...
      html: `<section class="slide"><div class="wrap">
        ...
        <p class="lead">독립협회는 민권과 자주독립의 가능성을 보여주었지만, 지도부의 민중관·황제권 인식·외세 인식에는 복잡한 모순이 있었습니다. 윤치호 일기는 그 모순을 가장 날카롭게 보여주는 1차 사료입니다.</p>
    ...
    return {
      ...
      html: `<section class="slide"><div class="wrap">
        ...
        <div class="paper" style="margin-top:1rem">
          ...
          <div class="quote">이 질문을 던지고 난 뒤 기존 독립협회 평가 슬라이드로 넘어가면 흐름이 자연스럽습니다.</div>
        </div>
  ...
  function injectDiarySlides(){
    ...
    const insertAt = Math.min(7, Math.max(1, slides.length - 1));
    slides.splice(insertAt, 0, buildIntroSlide(entries), buildFollowSlide(entries), buildIndexSlide(entries));
